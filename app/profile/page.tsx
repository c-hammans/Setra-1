...
export default function ProfilePage(){
  ...
  return <main className="profile-screen" style={theme} data-light-accent={contrast==="#0F172A"} data-theme={resolvedAppearance}>
    ...
    <div className="profile-content">
      ...
      <Link className="profile-awards-link" href="/awards"><span>AWARDS &amp; STREAKS</span><div><i>◆</i><p><b>Your training record</b><small>Consistency, milestones and the work adding up.</small></p><em>›</em></div></Link>
