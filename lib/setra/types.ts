...
export type PlannedLoad = {mode:"kg"|"band"|"bw";value:string;sourceUnit?:"kg"|"lb"};
export type TemplateExercise = { exerciseId: string; sets: number; reps: string; group?: string; note?: string; plannedLoad?:PlannedLoad };
